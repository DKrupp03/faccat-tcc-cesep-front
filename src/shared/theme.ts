...
export const TOKENS = {
  color: {
    ...
    // Status (atendimentos e pagamentos): um matiz distinto por status,
    // sem repetir cor entre módulos. Ponto/gráfico, texto e fundo suave.
    statusScheduled: "#857B70",
    statusScheduledText: "#57504A",
    statusScheduledBg: "#EFECE7",
    statusConfirmed: "#2F6FD6",
    statusConfirmedText: "#1E56B0",
    statusConfirmedBg: "#E6EEFB",
    statusAttended: "#2E8B3E",
    statusAttendedText: "#1F6B2D",
    statusAttendedBg: "#E5F3E7",
    statusNoShow: "#C48A00",
    statusNoShowText: "#8A6500",
    statusNoShowBg: "#FBF3D9",
    statusCancelled: "#D0342C",
    statusCancelledText: "#B0241D",
    statusCancelledBg: "#FCEAE9",

    statusPaid: "#0F9488",
    statusPaidText: "#0B6E65",
    statusPaidBg: "#E0F4F2",
    statusUnpaid: "#E8751A",
    statusUnpaidText: "#A94F07",
    statusUnpaidBg: "#FDEEE1",
    statusOverdue: "#C2185B",
    statusOverdueText: "#A0134A",
    statusOverdueBg: "#FBE7EF",
    statusFree: "#7C4DCC",
    statusFreeText: "#6238AD",
    statusFreeBg: "#F0EAFA",
