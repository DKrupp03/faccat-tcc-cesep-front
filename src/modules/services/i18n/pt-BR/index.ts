const services = {
  "headerCards": {
    "total": "Número total de atendimentos",
    "filtered": "Número de atendimentos filtrados",
  },
  ...
  "actions": {
    ...
    "delete.confirmation": "Tem certeza que deseja excluir este atendimento?</br>Ao continuar, <b>serão excluídos o prontuário e o pagamento</b> associados à ele!",
  ...
  "serviceTypes": {
    ...
    "organizational_psychology_career_guidance": "Psicologia Organizacional – Orientação de Carreira",
    "organizational_psychology_worker_health": "Psicologia Organizacional – Saúde do Trabalhador",
  },
} as const;
